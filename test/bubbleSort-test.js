...
describe('Sort numbers', function(){
  it('Bubble sort can sort first array of numbers', function(){
      var unsorted = [4,1,3]
      var sorted = [1,3,4]

      subject = bubbleSort(unsorted)

      assert.deepEqual(sorted, subject)
  })

  it('Bubble sort can sort second array of numbers', function(){
  ...
  it('Bubble sort can sort third array of numbers', function(){
  ...
  it('Bubble sort can sort forth array of numbers', function(){
  ...
  it('Bubble sort doesnt ruin already sorted array', function(){
