...
describe('Sort numbers', function(){
  it('Insertion sort can sort first array of numbers', function(){
      var unsorted = [4,1,3]
      var sorted = [1,3,4]

      subject = insertionSort(unsorted)

      assert.deepEqual(sorted, subject)
  })

  it('Insertion sort can sort second array of numbers', function(){
  ...
  it('Insertion sort can sort third array of numbers', function(){
  ...
  it('Insertion sort can sort forth array of numbers', function(){
  ...
  it('Insertion sort doesnt ruin already sorted array', function(){
